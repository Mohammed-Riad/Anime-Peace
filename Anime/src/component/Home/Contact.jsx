...
export default function Contact() {
    return (
        <>
            <div style={{
                backgroundImage: `url("https://c4.wallpaperflare.com/wallpaper/103/5/162/anime-anime-boys-jujutsu-kaisen-satoru-gojo-hd-wallpaper-preview.jpg")`,
                width: '100%',
                height: '300px',
                // backgroundRepeat: 'no-repeat center center cover',
            ...
            <div>
                ...
                <div className="w-full flex items-center justify-center my-12"  >
                    <div className=" lg:absolute top-40 sm:block shadow rounded py-12 lg:px-28 px-8 backdrop-blur-md" style={{ border: "1px solid black" }} >
